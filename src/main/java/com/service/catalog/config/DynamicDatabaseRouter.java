...
@Configuration
@EnableJpaRepositories(basePackages = "com.service.catalog", transactionManagerRef = "transcationManager", entityManagerFactoryRef = "entityManager")
...
public class DynamicDatabaseRouter {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder) {
        return builder.dataSource(dataSource()).packages("com.service.catalog").build();
    }
